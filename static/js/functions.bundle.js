...
"undefined" != typeof jQuery && ($ = jQuery.noConflict()),
  (function (e, t) {
    ...
    "use strict";
    var l = {pageTransition: !1, cursor: !1, tips: !0, headerSticky: !0, headerMobileSticky: !1, menuBreakpoint: 992, pageMenuBreakpoint: 992, gmapAPI: "AIzaSyAO2BYvn4xyrdisvP8feA4AS_PGZFxJDp4", scrollOffset: 60, scrollExternalLinks: !0, smoothScroll: !1, jsFolder: "js/", cssFolder: "css/"},
      c =
  ...
  (function (e, t) {
        ...
        PageMenu: {
          init: function (e) {
            ...
            return (
              ...
              ((i = N.getVars.elHeader.classList.contains("no-sticky") ? 0 : ("false" == N.getVars.elHeader.getAttribute("data-sticky-shrink") ? getComputedStyle(N.getVars.elHeader).getPropertyValue("--cnvs-header-height") : getComputedStyle(N.getVars.elHeader).getPropertyValue("--cnvs-header-height-shrink")).split("px")[0]),
        ...
        SliderMenuClass: {
          init: function (e) {
            return (
              ...
              (!N.getVars.elHeader.classList.contains("ignore-slider") && (N.getVars.elBody.classList.contains("is-expanded-menu") || (N.getVars.elHeader.classList.contains("transparent-header-responsive") && !N.getVars.elBody.classList.contains("primary-menu-open"))) && ((e = N.getVars.elSlider.querySelector(".swiper-slide-active")), te(e)),
              !N.getVars.elHeader.classList.contains("ignore-slider") && (N.getVars.elBody.classList.contains("is-expanded-menu") || (N.getVars.elHeader.classList.contains("transparent-header-responsive") && !N.getVars.elBody.classList.contains("primary-menu-open"))) && ((e = N.getVars.elSlider.querySelector(".active-revslide")), te(e)),
              T.setBSTheme(),
        ...
        ResizeVideos: {
          init: function (t) {
            ...
            N.isFuncTrue(function () {
              ...
              return !!e && (N.initFunction({class: "has-plugin-fitvids", event: "pluginFitVidsReady"}), (t = N.getSelector(t)).length < 1 || void t.parent().fitVids({customSelector: 'iframe[src*="youtube"],iframe[src*="vimeo"],iframe[src*="dailymotion"],iframe[src*="maps.google.com"],iframe[src*="google.com/maps"]', ignore: ".no-fv"}));
            });
          },
        },
        PageTransition: {
                ...
                (t = N.getSelector(t)).length < 1 ||
                  ...
                  void t.each(function () {
                    ...
                    "image" == a &&
                      ...
                      t.magnificPopup(e)),
                      "gallery" == a && (t.find('a[data-lightbox="gallery-item"]').parent(".clone").hasClass("clone") && t.find('a[data-lightbox="gallery-item"]').parent(".clone").find('a[data-lightbox="gallery-item"]').attr("data-lightbox", ""), t.find('a[data-lightbox="gallery-item"]').parents(".cloned").hasClass("cloned") && t.find('a[data-lightbox="gallery-item"]').parents(".cloned").find('a[data-lightbox="gallery-item"]').attr("data-lightbox", ""), t.magnificPopup({delegate: t.hasClass("grid-container-filterable") ? 'a.grid-lightbox-filtered[data-lightbox="gallery-item"]' : 'a[data-lightbox="gallery-item"]', type: "image", tLoading: "", closeOnContentClick: !0, closeBtnInside: i, fixedContentPos: !0, mainClass: "mfp-no-margins mfp-fade", image: {verticalFit: !0}, gallery: {enabled: !0, navigateByImgClick: !0, preload: [0, 1]}, closeIcon: l})),
          ...
          init: function (e) {
            return (
              ...
              void e.forEach(function (o) {
                ...
                a || ((a = document.createElement("div")).classList.add("alert", "alert-warning", "twitter-widget-alert", "text-center"), o.prepend(a), (a.innerHTML = '<div class="spinner-grow spinner-grow-sm me-2" role="status"><span class="visually-hidden">Loading...</span></div> ' + t)),
                  fetch(e + "?username=" + l)
                    .then(function (e) {
                      return e.json();
                    })
              ...
              return (
                ...
                (t = N.getSelector(t, !0, !1)).length < 1 ||
                  void t.each(function () {
                    ...
                    t.jflickrfeed({feedapi: i, limit: Number(a), qstrings: {id: e}, itemTemplate: '<a class="grid-item" href="{{image_b}}" title="{{title}}" data-lightbox="gallery-item"><img src="{{image_s}}" alt="{{title}}" /></a>'}, function (e) {
            ...
            return (
              ...
              void e.forEach(function (e) {
                ...
                12 < Number(t) && (t = 12),
                  ...
                  (r = t),
                  (t = i),
                  (s = (n = e).closest(".instagram-widget-alert")) || ((s = document.createElement("div")).classList.add("alert", "alert-warning", "instagram-widget-alert", "text-center"), n.insertAdjacentElement("beforebegin", s), (s.innerHTML = '<div class="spinner-grow spinner-grow-sm me-2" role="status"><span class="visually-hidden">Loading...</span></div> ' + t)),
                  fetch(a)
                    .then(function (e) {
                      return e.json();
                    })
              ...
              return (
                ...
                (t = N.getSelector(t)).length < 1 ||
                  void t.each(function () {
                    ...
                    "true" == r ? ((r = s.html().split(c)), (t = n.attr("data-loop") || "true"), (a = n.attr("data-shuffle")), (i = n.attr("data-cursor") || "true"), (l = n.attr("data-speed") || 50), (e = n.attr("data-backspeed") || 30), (n = n.attr("data-backdelay")), (t = "true" == t), (a = "true" == a), (i = "true" == i), s.html("").addClass("plugin-typed-init"), new Typed(s[0], {strings: r, typeSpeed: Number(l), loop: t, shuffle: a, showCursor: i, backSpeed: Number(e), backDelay: Number(n)})) : s.Morphext({animation: o, separator: c, speed: Number(l)});
                  }))
              );
            });
          },
                  ...
                  void t.each(function () {
                    ...
                    e.find("form").validate({
                      submitHandler: function (t) {
                        o.hide(),
                          "button" == s ? ((a = jQuery(t).find("button")), (i = a.html()), a.html('<i class="bi-arrow-repeat icon-spin nomargin"></i>')) : jQuery(t).find(".bi-envelope-plus").removeClass("bi-envelope-plus").addClass("bi-arrow-repeat icon-spin"),
                          jQuery(t).ajaxSubmit({
                            target: o,
                            dataType: "json",
                            resetForm: !0,
        ...
        Cookies: {
          init: function (e) {
            ...
            "true" == t && (N.cookie.set("__cnvs_cookies_accept", ""), N.cookie.remove("__cnvs_cookies_decline")),
              i &&
                (i?.classList.contains("gdpr-settings-sm") && i?.classList.contains("gdpr-settings-right") ? (r = "right") : i?.classList.contains("gdpr-settings-sm") && (r = "left"), "left" == r ? ((a = -o), (i.style.right = "auto"), (i.style.marginLeft = "1rem")) : "right" == r ? ((a = -o), (i.style.left = "auto"), (i.style.marginRight = "1rem")) : (a = -s), (i.style[r] = a + "px"), "1" != N.cookie.get("__cnvs_cookies_accept")) &&
                setTimeout(function () {
                ...
                p.onclick = function (e) {
                  e.preventDefault(),
                    a.classList.contains("read-more-wrap-open")
                      ...
                      : ("false" == l && p.classList.add("d-none"), (a.style.height = d + "px"), (a.style.overflow = ""), a.classList.add("read-more-wrap-open"), p && (p.innerHTML = l), "true" == u && (t.classList.remove("op-1"), t.classList.add("op-0"))),
                    (p = a.querySelector(s));
                };
              }),
    ...
    function $(e) {
      e.sliderPx.el &&
        fastdom.measure(function () {
          (e.scrollPos.y = window.scrollY), e.body.classList.contains("is-expanded-menu") && !e.isMobile ? (e.height + e.sliderPx.offset + 50 > e.scrollPos.y ? (e.classes.add("slider-parallax-visible"), e.classes.remove("slider-parallax-invisible"), e.scrollPos.y > e.sliderPx.offset ? ("object" == typeof e.sliderPx.el.querySelector(".slider-inner") ? ((u = -0.4 * (e.scrollPos.y - e.sliderPx.offset)), (p = -0.15 * (e.scrollPos.y - e.sliderPx.offset)), E(0, u, e.sliderPx.inner)) : ((u = (e.scrollPos.y - e.sliderPx.offset) / 1.5), (p = (e.scrollPos.y - e.sliderPx.offset) / 7), E(0, u, e.sliderPx.el)), E(0, p, e.sliderPx.caption)) : (e.sliderPx.el.querySelector(".slider-inner") ? E(0, 0, e.sliderPx.inner) : E(0, 0, e.sliderPx.el), E(0, 0, e.sliderPx.caption))) : (e.classes.add("slider-parallax-invisible"), e.classes.remove("slider-parallax-visible"))) : (e.sliderPx.el.querySelector(".slider-inner") ? E(0, 0, e.sliderPx.inner) : E(0, 0, e.sliderPx.el), E(0, 0, e.sliderPx.caption), e.classes.add("slider-parallax-visible"), e.classes.remove("slider-parallax-invisible"));
        });
    }
    function E(e, t, a) {
      a &&
